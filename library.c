...
typedef struct {
    char title[100];  // book name
    char author[50]; // book authors name
    char ISBN[20]; // book ISBN as a string
    int availability; // Status of Availability
} Book;

//user structure
typedef struct {
    int userID;  //user ID
    char name[50]; //users Name
...
//function to list books and its status
void listBooks() {
